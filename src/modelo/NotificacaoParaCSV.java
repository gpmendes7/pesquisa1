...
public class NotificacaoParaCSV {
	...
	public NotificacaoParaCSV() {
		
	}

	public NotificacaoParaCSV(String numeroNotificacao, String nomeCompleto, String cpf, String dataNotificacao,
			...
			String classificacaoFinal, String descartada) {
		super();
	...
	public String getDescartada() {
		return descartada;
	}

	public void setDescartada(String descartada) {
		this.descartada = descartada;
	}
